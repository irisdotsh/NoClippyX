...
using ImGuiNET;
using static NoClippyX.NoClippyX;
...
namespace NoClippyX.Modules
{
    public class AnimationLock : Module
    {
        ...
        private const float simulatedRTT = 0f;
        ...
        private static float GetAnimationLock(uint actionID) => 0.3f + simulatedRTT;
        ...
        private unsafe void ReceiveActionEffect(int sourceActorID, nint sourceActor, nint vectorPosition, nint effectHeader, nint effectArray, nint effectTrail, float oldLock, float newLock)
        {
            try
            {
                ...
                var appliedLock = appliedAnimationLocks.GetValueOrDefault(sequence, 0.3f);
        ...
        public override void DrawConfig()
        {
            ...
            PluginUI.SetItemTooltip("Modifies the way the game handles animation lock," +
                "\ncausing it to simulate 0 ms ping.");
