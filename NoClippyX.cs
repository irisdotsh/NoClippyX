...
namespace NoClippyX
{
    public class NoClippyX : IDalamudPlugin
    {
        public static NoClippyX Plugin { get; private set; }
        public static Configuration Config { get; private set; }

        public NoClippyX(IDalamudPluginInterface pluginInterface)
        {
            Plugin = this;
        ...
        [Command("/noclippyx")]
        [HelpMessage("/noclippyx [on|off|toggle|dry|help] - Toggles the config window if no option is specified.")]
        private void OnNoClippy(string command, string argument)
        {
            switch (argument)
            {
                ...
                case "":
                    ...
                    break;
                default:
                    PrintEcho("Invalid usage: Command must be \"/noclippyx <option>\"." +
        ...
        public static void PrintEcho(string message) => DalamudApi.ChatGui.Print($"[NoClippyX] {message}");
        public static void PrintError(string message) => DalamudApi.ChatGui.PrintError($"[NoClippyX] {message}");
